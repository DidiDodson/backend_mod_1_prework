...
- if statements: make a branch in the code to allow for alternatives to be chosen and/or printed.
- method: also known as a function. This is a means by which we can execute code many times without having to re-type or redefine/re-name the activity the method accomplishes.
