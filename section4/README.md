...
- method: a set of expressions that returns a value
- class: the basic outline of what an object should be (attribute/state) and what it should do (method/behavior)
- class instance: an object in a given class
- properties: the attributes and methods of a class
